...
@Component({
  selector: 'app-venda-tesouro-direto',
  templateUrl: './venda-tesouro-direto.component.html',
  styleUrls: ['./venda-tesouro-direto.component.scss']
})
export class VendaTesouroDiretoComponent implements OnInit {
  constructor(
    ...
    private dialog : MatDialogRef<VendaTesouroDiretoComponent>, 
      ...
      this.service.atualizarTesouro(tesouroDireto).subscribe({
        next:(res) => {
            ...
            this.movService.Salvarmovimentacao(movimentacao).subscribe({
              next:(res) => {
                this.toastr.success('Gravando!', 'Venda inserida com Sucesso!');
