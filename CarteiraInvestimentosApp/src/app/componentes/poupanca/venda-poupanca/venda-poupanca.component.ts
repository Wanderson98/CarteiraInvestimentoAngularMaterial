...
@Component({
  selector: 'app-venda-poupanca',
  templateUrl: './venda-poupanca.component.html',
  styleUrls: ['./venda-poupanca.component.scss']
})
export class VendaPoupancaComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    private dialog : MatDialogRef<VendaPoupancaComponent>,
