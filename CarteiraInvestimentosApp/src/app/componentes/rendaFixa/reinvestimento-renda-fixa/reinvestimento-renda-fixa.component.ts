...
@Component({
  selector: 'app-reinvestimento-renda-fixa',
  templateUrl: './reinvestimento-renda-fixa.component.html',
  styleUrls: ['./reinvestimento-renda-fixa.component.scss']
})
export class ReinvestimentoRendaFixaComponent implements OnInit {
  ...
  constructor(private formBuilder: UntypedFormBuilder, 
    ...
    private dialog : MatDialogRef<ReinvestimentoRendaFixaComponent>,
